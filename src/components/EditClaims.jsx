    ...
    <div>
      ...
      {isLoading ? (
        <div className="flex justify-center items-center py-8">
          <div className="text-lg">Loading identity data...</div>
        </div>
      ) : (
        <>
          ...
          <div className="flex justify-end gap-4">
            <Button
              ...
              className="flex items-center gap-2 min-w-max text-center font-semibold rounded-2xl p-2 h-fit bg-[#7F56D9] text-white disabled:opacity-50"
            >
              <div>Save Claims</div>
            </Button>
          </div>
        </>
      )}  {/* Close the loading conditional */}
    </div>
  );
};
